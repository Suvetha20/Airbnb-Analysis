...
def datafr():
    df= pd.read_csv("C:/Users/User/Desktop/New folder/Airbnb.csv")
    return df
...
if select == "Home":
    ...
    st.header(":rainbow[About Airbnb]")
    st.write("")
    ...
    st.header(":rainbow[Background of Airbnb]")
    st.write("")
...
if select == "Data Exploration":
    ...
    with tab2:
        ...
        def datafr():
            df_a= pd.read_csv("C:/Users/User/Desktop/New folder/Airbnb.csv")
            return df_a
